...
- a `NamespaceVendingRequest` for `e2e-probe`;
- a Backstage `Resource` entity owned by `group:default/pe-app-team-e2e`;
- quota tier `S` mapped to concrete CPU, memory, and pod
  limits.
