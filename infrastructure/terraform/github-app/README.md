# platform-vending-bot GitHub App (Stage 05)
...
- exports the app metadata and Key Vault secret name consumed by Stage 05
  workflows.
...
private key, and write the private key to the Stage 01 seed Key Vault with the
