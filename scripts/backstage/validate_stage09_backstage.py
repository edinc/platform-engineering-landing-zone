...
def validate_gitops() -> None:
    ...
    require_contains("backstage/deploy/templates/configmap.yaml", 'trimSuffix "/"')
    ...
    require_contains("backstage/deploy/templates/deployment.yaml", "checksum/config")
    require_contains("backstage/deploy/templates/deployment.yaml", "checksum/rbac-groups")
    require_contains("backstage/deploy/values.yaml", "rbacGroups:")
    ...
    require_contains("backstage/catalog-reconciler/reconciler.py", "outside demo environments")
    ...
    require_contains("platform-gitops/clusters/_base/controllers/platform/kyverno.yaml", "${aks_kubelet_client_id}")
    require_contains("infrastructure/terraform/platform/gitops.tf", "aks_kubelet_client_id")
    ...
    require_contains("platform-gitops/clusters/_base/addon-config/backstage/helmrelease.yaml", "host: ${platform_profile}.backstage.${platform_root_domain}")
    require_contains("platform-gitops/clusters/_base/addon-config/backstage/helmrelease.yaml", "applicationTeamGroupMapJson: ${backstage_application_team_group_map_json}")
