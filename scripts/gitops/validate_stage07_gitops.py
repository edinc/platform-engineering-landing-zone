...
def validate_terraform_and_workflows() -> None:
    ...
    require_contains("platform-gitops/clusters/overlays/demo/controllers/public-backstage-kustomization.yaml", 'clusterconfig.azure.com/use-managed-source: "true"')
